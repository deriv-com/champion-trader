...
describe("DesktopContractDetailsPage", () => {
    ...
    it("has correct layout structure", () => {
        ...
        expect(mainContainer).toHaveClass("flex flex-col bg-theme w-full");

        // Check left panel
        const leftPanel = screen.getByTestId("left-panel");
        expect(leftPanel).toHaveClass("w-[320px] bg-theme flex flex-col");

        // Check content area
        const contentArea = screen.getByTestId("content-area");
        expect(contentArea).toHaveClass("flex-1 overflow-y-auto pb-20 space-y-4 bg-theme");
