...
export const OrderDetails: React.FC = () => {
  ...
  return (
    <div className="mt-4 p-4 bg-white dark:bg-gray-800 rounded-lg border-b border-gray-300 dark:border-gray-600 shadow-md">
      ...
      {details.map((detail, index) => (
        <div key={index} className="col-span-2 flex justify-between border-b border-gray-300 py-2">
          <span className="text-gray-600 dark:text-gray-300 font-ibm-plex text-[14px] leading-[22px] font-normal">{detail.label}</span>
