...
export const OrderDetails: React.FC = () => {
  ...
  return (
    <div className="w-full mt-4 p-4  dark:bg-gray-800 text-text-primary-color dark:text-white rounded-lg shadow-md">
      ...
      {details.map((detail, index) => (
        <div key={index} className="w-full flex justify-between items-center border-b border-gray-300 py-2">
          <span className="text-order-details-text-color dark:text-white font-ibm-plex text-[14px] leading-[22px] font-normal">{detail.label}</span>
