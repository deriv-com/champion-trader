...
export const SideNav: React.FC = () => {
  ...
  return (
    <nav className={`${isLandscape && isSideNavVisible ? 'flex' : 'hidden'} fixed z-[60] flex-col h-[100dvh] sticky top-0 w-16 border-r bg-white dark:bg-gray-900 overflow-y-auto`}>
        ...
        {isLoggedIn && (
          <>
            ...
            >
              ...
              <span className={`text-xs ${activeSidebar === 'positions' ? "text-black dark:text-white" : "dark:text-gray-300"}`}>Positions</span>
            </button>
          </>
        )}
        <button
