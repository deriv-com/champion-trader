...
describe("Chip", () => {
    ...
    it("applies selected styles when isSelected is true", () => {
        const { container } = render(<Chip isSelected>{defaultProps.children}</Chip>);
    ...
    it("applies unselected styles when isSelected is false", () => {
        const { container } = render(<Chip isSelected={false}>{defaultProps.children}</Chip>);
    ...
    it("handles long text with ellipsis", () => {
        const { container } = render(<Chip>{"Very long text that should be truncated"}</Chip>);
