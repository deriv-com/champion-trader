        ...
        <div className="p-4 space-y-4">
            ...
            <div className="flex items-center justify-between cursor-pointer py-2">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    />
                    <div className="w-11 h-6 bg-theme-secondary peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-theme-active peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-theme after:border-theme after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-theme peer-checked:bg-blue-600"></div>
                </label>
            </div>
            {isLoggedIn && (
                <button
