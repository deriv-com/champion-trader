                ...
                >
                    ...
                    <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                            <div className="text-base font-bold text-black/[0.72] leading-6 truncate">
                                {title}
                            </div>
                            <ChevronDown className="w-4 h-6 text-black/[0.72] flex-shrink-0 stroke-[1.5]" />
                        </div>
                        <div className="text-sm text-black/[0.48] leading-5 truncate">
                            {subtitle}
                        </div>
                    </div>
                </div>
        ...
        >
            <div className="flex items-center gap-4 px-4 py-3">
                ...
                <div className="min-w-0">
                    <div className="flex items-center gap-2">
                        <div className="text-base font-bold text-[#4C4C4C] leading-6 truncate">
                            {title}
                        </div>
                        <ChevronDown className="w-5 text-[#4C4C4C] flex-shrink-0 stroke-[1.5]" />
                    </div>
                    <div className="text-sm text-[#808080] leading-5 truncate">{subtitle}</div>
                </div>
            </div>
        </div>
    );
