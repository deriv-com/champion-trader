            ...
            <div className="space-y-4 text-sm">
                <div>
                    ...
                    <p className="text-gray-600 mb-2">
                        If you select Rise, you win the payout if the exit spot
                        is strictly higher than the entry spot.
                    </p>
                ...
                <div>
                    ...
                    <p className="text-gray-600 mb-2">
                        If you select Fall, you win the payout if the exit spot
                        is strictly lower than the entry spot.
                    </p>
                ...
                <div>
                    ...
                    <p className="text-gray-600 mb-2">
                        If you select "Allow equals", you win the payout if exit
                        spot is higher than or equal to entry spot for Rise.
                        Similarly, you win the payout if exit spot is lower than
                        or equal to entry spot for Fall.
                    </p>
                </div>
