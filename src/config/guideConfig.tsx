      ...
      <div className="space-y-4 text-sm">
        <div>
          ...
          <p className="text-[var(--text-color)] mb-2">
            If you select Rise, you win the payout if the exit spot is strictly
        ...
        <div>
          ...
          <p className="text-gray-600text-[var(--text-color)]">
            If you select Fall, you win the payout if the exit spot is strictly
        ...
        <div>
          ...
          <p className="text-[var(--text-color)] mb-2">
            ...
            higher than or equal to entry spot for Rise. Similarly, you win the
            payout if exit spot is lower than or equal to entry spot for Fall.
          </p>
        </div>
