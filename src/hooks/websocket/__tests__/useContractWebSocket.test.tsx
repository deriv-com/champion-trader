...
describe("useContractWebSocket", () => {
    ...
    it("should call onPrice when price updates", () => {
        ...
        renderHook(() =>
            useContractWebSocket(mockRequest, mockAuthToken, { onPrice: mockOnPrice })
        );
    ...
    it("should call onError when error occurs", () => {
        ...
        renderHook(() =>
            useContractWebSocket(mockRequest, mockAuthToken, { onError: mockOnError })
        );
    ...
    it("should call onConnect when connected", () => {
        ...
        renderHook(() =>
            useContractWebSocket(mockRequest, mockAuthToken, { onConnect: mockOnConnect })
        );
    ...
    it("should call onDisconnect when disconnected", () => {
        ...
        renderHook(() =>
            useContractWebSocket(mockRequest, mockAuthToken, { onDisconnect: mockOnDisconnect })
        );
    ...
    it("should reinitialize service and request price when auth token changes", () => {
        const { rerender } = renderHook(({ token }) => useContractWebSocket(mockRequest, token), {
